...
const Footer = () => {
    return (
        <footer className='w-full bg-black text-white font-serif px-8 py-10'>
            <div className='grid grid-cols-1 md:grid-cols-4 gap-8'>

                {/* Contact Us */}
                <div className='space-y-4'>
                    <h3 className='text-2xl font-bold text-orange-600'>Contact Us</h3>
                    <div className='flex items-start gap-2'>
                        <IoLocationSharp className='text-red-600 text-xl mt-1' />
                        <p className='text-sm'>
                    ...
                    <div className='flex items-center gap-2'>
                        <BiLogoGmail className='text-red-800 text-lg' />
                ...
                {/* Services */}
                <div className='space-y-4'>
                    <h3 className='text-2xl font-bold text-orange-600'>Resources</h3>
                    <ul className='space-y-2 text-sm'>
            ...
            <li className='hover:text-yellow-400 cursor-pointer'><a href="https://www.facebook.com/OdishaHolidays.in"><CiFacebook className='text-2xl text-blue-700 hover:text-blue-900 transition'/></a></li>
             <li className='hover:text-yellow-400 cursor-pointer'><a href="https://x.com/OdishaHolidays"><FaXTwitter className='text-2xl text-blue-700 hover:text-blue-900 transition'/></a></li>
            <li className='hover:text-yellow-400 cursor-pointer'><a href="https://in.pinterest.com/Odishaholidays/_saved/"><FaPinterest className='text-2xl text-red-700 hover:text-blue-900 transition'/></a></li>
           <li className='hover:text-yellow-400 cursor-pointer'><a href="https://www.instagram.com/odishaholidays/"><LuInstagram className='text-2xl text-pink-800 hover:text-blue-900 transition'/></a></li>
            <li className='hover:text-yellow-400 cursor-pointer'><a href="https://www.youtube.com/channel/UCdGqp-2xTHhJfLHJqkaIS7A"><FaYoutube className='text-2xl text-red-600 hover:text-blue-900 transition'/></a></li>
          </ul>
                </div>
